...
<head>
    <style type="text/css">
        ...
        .slideshow .prev{border-radius:3px 0 0 3px};
...
<!--            <img src="Gambar/8.png" height="640px">-->
            <a href="BelumLogin/PilihBarang.php?id=<?php echo $b['IDProduk']; ?>">
                <?php
...
<!--            style='max-width: 465px; max-height: 620px;'-->
            <a href="BelumLogin/PilihBarang.php?id=<?php echo $d['IDProduk']; ?>">
                <?php
...
<!--            <img src="Gambar/10.png" height="640px">-->
            <a href="BelumLogin/PilihBarang.php?id=<?php echo $f['IDProduk']; ?>">
                <?php
...
<!--                        <img src="Gambar/1.jpg" class="d-block w-100" alt="gambar" height="250px">-->
                        <a href="BelumLogin/PilihBarang.php?id=<?php echo $h['IDProduk']; ?>">
                            <?php
...
<!--                        <img src="Gambar/2.jpg" class="d-block w-100" alt="gambar" height="250px">-->
                        <a href="BelumLogin/PilihBarang.php?id=<?php echo $j['IDProduk']; ?>">
                            <?php
...
<!--                        <img src="Gambar/3.jpg" class="d-block w-100" alt="gambar" height="250px">-->
                        <a href="BelumLogin/PilihBarang.php?id=<?php echo $l['IDProduk']; ?>">
                            <?php
...
<!--                        <img src="Gambar/4.jpg" class="d-block w-100" alt="gambar" height="250px">-->
                        <a href="BelumLogin/PilihBarang.php?id=<?php echo $n['IDProduk']; ?>">
                            <?php
...
<!--                        <img src="Gambar/5.jpg" class="d-block w-100" alt="gambar" height="250px">-->
                        <a href="BelumLogin/PilihBarang.php?id=<?php echo $p['IDProduk']; ?>">
                            <?php
...
<!--                            5 Desember 2001 <br>-->
                            ...
                            <a href="BelumLogin/PilihBarang.php?id=<?php echo $v['IDProduk']; ?>">
