...
if (isset($_POST['SubmitSS2'])) {
    $IDProdukSS2 = $_POST['IDProdukSS2'];
    $AturFotoSS2 = $_POST['AturFotoSS2'];
    $NamaKolom = $_POST['NamaKolomSS2'];
    $NamaSlideShow = "SlideShow 2";
    ...
    $IDSlideShow2 = $c['IDSlideShow'];

    if ($JumlahData < 1) {
        $sql3 = "INSERT INTO HalamanDepan (NamaSlideShow, NamaKolom, PilihanFoto, IDProduk)
                VALUES ('$NamaSlideShow', '$NamaKolom', '$AturFotoSS2', $IDProdukSS2)";
        ...
        $sql5 = "UPDATE HalamanDepan SET NamaSlideShow = '$NamaSlideShow', NamaKolom = '$NamaKolom', 
                PilihanFoto = '$AturFotoSS2', IDProduk = $IDProdukSS2 
                WHERE IDSlideShow = $IDSlideShow2";
    ...
    <div id="spasi">
        ...
        while ($a = mysqli_fetch_array($result)){
            ...
            <table id="tabelBelanjaan" class="tabelBelanjaan">
                <tr>
                    <td align="center">
                        <input name="IDProdukSS2" value="<?php echo $a['IDProduk']; ?>" hidden>
...
<!--                        END TAMPILKAN FOTO-->
                ...
                <tr>
                    <td align="Left">
                        <div style="margin-left: 20px; margin-top: 30px;">
                            Pilih Foto: &nbsp;
                            <select name="AturFotoSS2" class="lihatproduk4">
                                <?php
                                if (!empty($a['Foto1'])) {
                ...
                <tr>
                    <td>
                        <div style="margin-left: 20px; margin-top: 30px;">
                            Pilih Kolom: &nbsp;
                            <select name="NamaKolomSS2" class="lihatproduk4">
                                <option value='Kolom 1'> Kolom 1 </option>
                                <option value='Kolom 2'> Kolom 2 </option>
                                <option value='Kolom 3'> Kolom 3 </option>
                                <option value='Kolom 4'> Kolom 4 </option>
                                <option value='Kolom 5'> Kolom 5 </option>
                            </select>
                    </td>
                </tr>
                <tr>
...
<!--                        </a>-->
                        <button name="SubmitSS2" class="lihatproduk3" type="submit" style="margin-left: 20px; margin-bottom: 10px">
                            Submit </button> &nbsp
                    </td>
                </tr>
