...
if (isset($_POST['SubmitSS3'])) {
    $IDProdukSS3 = $_POST['IDProdukSS3'];
    $AturFotoSS3 = $_POST['AturFotoSS3'];
    $NamaKolom = "Kolom 1";
    $NamaSlideShow = "SlideShow 3";
    ...
    $IDSlideShow3 = $c['IDSlideShow'];


    if ($JumlahData < 1) {
        $sql3 = "INSERT INTO HalamanDepan (NamaSlideShow, NamaKolom, PilihanFoto, IDProduk)
            VALUES ('$NamaSlideShow', '$NamaKolom', '$AturFotoSS3', $IDProdukSS3)";
        ...
        $sql5 = "UPDATE HalamanDepan SET NamaSlideShow = '$NamaSlideShow', NamaKolom = '$NamaKolom', 
                PilihanFoto = '$AturFotoSS3', IDProduk = $IDProdukSS3 
                WHERE IDSlideShow = $IDSlideShow3";
    ...
    <div id="spasi">
        ...
        while ($a = mysqli_fetch_array($result)){
            ...
            <table id="tabelBelanjaan" class="tabelBelanjaan">
                <tr>
                    <td align="center">
                        <input name="IDProdukSS3" value="<?php echo $a['IDProduk']; ?>" hidden>
                ...
                <tr>
                    <td align="Left">
                        <div style="margin-left: 20px; margin-top: 30px;">
                            Pilih Foto: &nbsp;
                            <select name="AturFotoSS3" class="lihatproduk4">
                                <?php
                                if (!empty($a['Foto1'])) {
...
<!--                        </a>-->
                        <button name="SubmitSS3" class="lihatproduk3" type="submit" style="margin-left: 20px; margin-bottom: 10px">
                            Submit </button> &nbsp
                    </td>
                </tr>
