...
if (isset($_POST['SubmitUpdateDataBayar'])) {
    $NoRek = $_POST['NoRek'];
    $NamaBank = $_POST['NamaBank'];
    $NamaPemilik = $_POST['NamaPemilik'];

    $query = "UPDATE DataPembayaran SET NoRek = $NoRek, NamaBank = '$NamaBank', NamaPemilik = '$NamaPemilik'
                WHERE IDBayar = $id";
    $hasil = mysqli_query($conn, $query);

    if ($hasil){
        echo "<script>alert('Update Data Pembayaran Berhasil')</script>";
    } else{
        echo "<script>alert('Update Data Pembayaran Gagal')</script>";
    }
}
...
<?php
$sql = "SELECT * FROM DataPembayaran WHERE IDBayar = $id";
            ...
            <tr align="center">
                ...
                <td align="center">
                    <input name="NamaPemilik" class="kotakInput" type="text" maxlength="300"
                           value="<?php echo $a['NamaPemilik']; ?>">
                </td>
            </tr>
            <tr>
                <td colspan="3" align="center">
                    <button name="SubmitUpdateDataBayar" class="lihatproduk" type="submit">Update Data Pembayaran</button>
                </td>
            </tr>
        </table>
        <br><br><br><br><br>
