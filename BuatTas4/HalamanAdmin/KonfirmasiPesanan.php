    ...
    <table id="tabelInput">
        ...
        <tr>
            <td colspan="3">
                ...
                Ongkos Kirim: <?php echo "Rp " . number_format($a['OngkosKirim'],0,'','.'); ?>
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td colspan="3" align="center">
                ...
                ?>
                <B>TOTAL HARGA YANG HARUS DIBAYAR: Rp <?php echo number_format($TotalBelanjaan + $OngkosKirim,0,'','.'); ?> </B>
            </td>
        </tr>
        <tr>
            <td colspan="3" align="center">
                ...
                <a href="UpdateKonfirmasiPembayaran.php?id=<?php echo $a['IDTransaksi']; ?>"
                   onclick="return confirm('Yakin Ingin mengkonfirmasi pembayaran ?')">

                    <button name="KonfirmasiBayar" class="lihatproduk"> Konfirmasi Pembayaran</button>
                </a>
            </td>
        </tr>
    </table>
