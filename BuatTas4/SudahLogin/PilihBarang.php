...
//                    Jika tersedia stock lebih dari 1
                    if ((int) $Stock >= 1) {

                        $sql4 = "SELECT * FROM Keranjang WHERE IDProduk = $IDProduk";
                        $result4 = mysqli_query($conn, $sql4);
                        $JumlahData = mysqli_num_rows($result4);
                        //            Kalau Jumlah data keranjang dengan ID produk $IDProduk kurang dari 1... INSERT ...
                        if ($JumlahData < 1) {
                            ...
                            $d = mysqli_fetch_array($result6);

                            $JumlahBarang = $d['JumlahBarang'];

                            $JumlahData2 = mysqli_num_rows($result6);
//                            Kalau barang dgn id tertentu ada lebih dari 1 barang di keranjang...
                            if ($JumlahData2 >= 1) {
                                if ($JumlahBarang < (int)$Stock) {
                                    if ($Jumlah + $JumlahBarang <= (int)$Stock) {
//                                        Update keranjang akan dilakukan dengan syarat jumlah barang di keranjang lebih kecil dari jumlah stock
//                                        dan jumlah barang yang akan ditambahkan + jumlah barang yang sudah ada di keranjang
//                                        harus lebih keci dari stock yang ada
                                    ...
                                    echo "<script>alert('Anda sudah menambahkan barang ke keranjang sejumlah stock yang tersisa!')</script>";
                                }
                            } else{
//                                Untuk kasus dimana jumlah yang ingin ditambahkan pembeli ke keranjang
//                                lebih kecil atau sama dengan jumlah stock yang ada
                                if ($Jumlah <= (int)$Stock) {
