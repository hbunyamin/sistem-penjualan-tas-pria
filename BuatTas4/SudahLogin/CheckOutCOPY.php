    ...
    while ($e = mysqli_fetch_array($hasil5)) {
        ...
        while ($f = mysqli_fetch_array($hasil6)) {
            ...
            if ($Alamat == null OR $NmrHp == null) {
                ...
                VALUES ('$TglTransaksi', '$OpsiPengiriman', $OngkosKirim, '$OpsiPembayaran',
                        '$StatusPembayaran')";
...
while ($a = mysqli_fetch_array($result)) {
    ...
    <table id="tabelAlamat">
        ...
        <tr>
            ...
            <td>
                <a href="UpdateAlamat.php?id=<?php echo $_SESSION['Username'] ?>">
                    <button name="GantiAlamat" type="button" class="lihatproduk"> Ganti Alamat </button>
                </a>
            </td>
        </tr>
    </table>
...
<div id="kotakBelanjaan">
    ...
    <table id="tabelBelanjaan">
        ...
        $sql2 = "SELECT k.IDKeranjang, k.JumlahBarang, k.IDProduk, k.IDUser, k.Variasi, k.IDTransaksi,
                    p.NamaProduk, p.Harga, u.Username, k.TotalBelanjaan, p.Foto1
                FROM Keranjang as k
                JOIN Produk as p
                ON k.IDProduk = p.IDProduk
                JOIN User as u
            ...
            <td colspan="2">
                ...
                while ($c = mysqli_fetch_array($result3)) {
                    ...
                    <input type="number" name="TotalHargaBelanjaan"
                           value="<?php echo number_format($c['SUM(k.TotalBelanjaan)'],0,'','.'); ?>" hidden>
                    <?php
                    echo "Rp " . number_format($c['SUM(k.TotalBelanjaan)'],0,'','.') ;
                ...
                <select name="OpsiPengiriman" class="lihatproduk">
                    ...
                    while ($row = mysqli_fetch_array($hasil1)) {
                        ...
                        <option value="<?php echo $row['NamaEkspedisi'] ?>">
                            ...
                            echo " (" . number_format($row['Harga'],0,'','.') . ")"; ?></option>
                        <?php
                    }
                    ?>
                </select>
