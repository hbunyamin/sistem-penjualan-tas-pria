...
if (isset($_POST['SubmitProfil'])) {
    ...
    $query = "UPDATE User SET NamaDepan = '$NamaDepan', NamaBelakang = '$NamaBelakang', TglLahir = '$TglLahir',
                Email = '$Email', NmrHP = $NmrHP, JenisKel = '$JenisKel', Alamat = '$Alamat', Kota = '$kota_tujuan'
    WHERE Username = '$id'";
    $hasil = mysqli_query($conn, $query);

    if ($hasil){
        echo "<script>alert('Ubah Profil Berhasil'); history.go(-2);</script>";
    } else{
...
<table id="TabelProfil">
    <form method="POST">
        <tr>
            <td align="center">
                <table style="width: 460px; height: 400px; ">
                    <tr>
                        <td>
                            Nama depan
                        </td>
                        ...
                        <td>
                            <input name="NamaDepan" type="text" value="<?php echo $a['NamaDepan']; ?>"
                                   placeholder="Masukan Nama Depan Anda"
                               style="color: #155799; border: 2px solid #155799; text-align: left; width: 200px; height: 33px;">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input name="NamaBelakang" type="text" value="<?php echo $a['NamaBelakang']; ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="TglLahir" type="date" value="<?php echo $a['TglLahir'] ?>"
                               style="color: #155799; border: 2px solid #155799; text-align: left;
                               width: 200px; height: 33px; color: #155799; font-family: 'Comic Sans MS'">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input name="Email" type="email" value="<?php echo $a['Email']; ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="NmrHP" type="number" value="<?php echo $a['NmrHP']; ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="JenisKel" class="kotakInput">
<!--                                <option value="">Please Select</option>-->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="Alamat" type="text" value="<?php echo $a['Alamat']; ?>"
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <select class="kotakInput" id="kota_tujuan" name="kota_tujuan" required="">
                                <option></option>
                            </select>
                    ...
                    <tr>
                        <td colspan="3">
                            <a href="#">
                                <button name="SubmitProfil" class="lihatproduk" > Submit </button>
                            </a>
                        </td>
                    </tr>
                </table>
